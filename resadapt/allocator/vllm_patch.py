...
if __name__ == "__main__":
    ...
    MODEL_PATH = "YOUR_WORKSPACE_PATH/models/qwen2.5_vl-3b"
    video_path ="YOUR_WORKSPACE_PATH/vlm_datasets/LLaVA-Video-178K/gpt4o_caption_prompt/83FR0RjX7qA.mp4"
    ...
    # breakpoint()
    from resadapt.utils.utils import tensor_to_pil_list, expand_video_prompt, tensor_to_tensor_list, expand_image_prompt, tensor_to_temporal_stack_list, split_video_metadata
