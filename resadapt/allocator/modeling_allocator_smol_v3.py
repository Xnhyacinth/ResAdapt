...
from resadapt.allocator.aznet_smol_v3 import RegressionHeadAllocatorSmol
...
class SmolAllocatorForConditionalGeneration(PreTrainedModel):
    ...
    def scale_multi_modal(
        ...
        **kwargs,
        ...
        frame_metrics = self.allocator.get_frame_metrics() if compute_frame_metrics_param else {}
...
if __name__ == "__main__":
    ...
    # save_path = "/mnt/bn/jiangzhongtao/users/liaohuanxuan/models/allocator_smolv1"
