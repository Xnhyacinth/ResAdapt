...
###
from visionthink.mytrainer import RayPPOTrainer
###
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            ### 
            from visionthink.adaptive.fsdp_workers import ActorRolloutRefWorker, AsyncActorRolloutRefWorker
            ###
            ...
            ###
            from visionthink.adaptive.megatron_workers import ActorRolloutRefWorker, AsyncActorRolloutRefWorker
            ###
