                    ...
                    try:
                        ...
                        if video_key in doc and doc[video_key]:
                            videos, video_metadata = zip(
                                *[
                                    process_video(
                                        video, image_patch_size=self.image_patch_size, return_video_metadata=True, nframes=int(os.environ.get("NFRAMES", 8))
                                    )
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            if row_dict_videos:
                videos, video_metadata = zip(
                    *[
                        process_video(video, image_patch_size=self.image_patch_size, return_video_metadata=True, nframes=int(os.environ.get("NFRAMES", 8)))
