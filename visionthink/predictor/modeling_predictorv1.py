...
def main():
    ...
    # config.sim_scale_coef = 1.0  # Strong regularization
    # config.sim_scale_weight = 0.2  # Internal weight
    # config.sim_tau = 0.7  # Only penalize if similarity > 0.75 (high redundancy)
    # config.sim_temp = 0.1  # Sharp transition
    # config.sim_gamma = 0.1  # Aggressive compression drop (0.1)
