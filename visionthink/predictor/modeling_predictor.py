...
class PredictorForConditionalGeneration(PreTrainedModel):
    ...
    _no_split_modules = ["PredictorDecoderLayer", "ProjectorBlock", "Qwen2_5_VLVisionBlock"]
...
def main():
    ...
    model_path = "/mnt/bn/jiangzhongtao/users/liaohuanxuan/visionthink/ckpts/VideoQA_Qwen_Verify/r4-mix_pt_asym_s_sc_gt_is_filt_fr_new_enc0.1_cen0.3_nf32_vidm-dp2-s16-7B-bsz128-mini64-n1-max2.0-l4-r8_2e-6/global_step_60/pred"
