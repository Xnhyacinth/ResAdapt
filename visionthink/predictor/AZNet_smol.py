...
from visionthink.predictor.AZNetv4 import FrameWiseScalePredictorLightV2
from visionthink.predictor.DifferentiableImportancePredictor_v2 import DifferentiableImportancePredictor
...
class RegressionHeadPredictorSmol(ModuleUtilsMixin, nn.Module):
    def __init__(self, vision_config):
        ...
        scorer_cls = DifferentiableImportancePredictor if use_differentiable else FrameWiseScalePredictorLightV2
        scorer_kwargs = dict(
            dim=output_dim,
