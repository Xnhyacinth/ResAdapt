...
# project_name='debug'
exp_name="${scale_multi_modal_data}-${scale_n}-7B-Single-bsz${train_prompt_bsz}-mini${train_prompt_mini_bsz}-n${n_resp_per_prompt}-min${min_scale}-max${max_scale}-len${max_prompt_length}"
