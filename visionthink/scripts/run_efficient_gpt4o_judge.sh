python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/mnt/bn/jiangzhongtao/users/liaohuanxuan/VisionThink/datasets/VisionThink-General-Train \
    data.val_files=/mnt/bn/jiangzhongtao/users/liaohuanxuan/VisionThink/datasets/VisionThink-General-Val \
