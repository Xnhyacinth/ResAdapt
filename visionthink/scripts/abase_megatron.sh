...
project_name='GeneralQA_Qwen_Verify_Megatron'
project_name='debug_meg'
exp_name="Gen-3B-ray-Megatron-TP${train_tp}-bsz${train_prompt_bsz}-mini${train_prompt_mini_bsz}"
...
DIST_CKPT_PATH=${MODEL_PATH}-MCORE
