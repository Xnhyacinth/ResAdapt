...
project_name='debug'
exp_name="Gen-7B-ray-bsz${train_prompt_bsz}-mini${train_prompt_mini_bsz}-n${n_resp_per_prompt}-min${min_scale}-max${max_scale}"
...
python3 -m visionthink.main_ppo \
    ...
    actor_rollout_ref.model.min_scale=${min_scale} \
    actor_rollout_ref.model.max_scale=${max_scale}  \
